...
export default function ControlDeckPage() {
    ...
    async function runPaidQuery() {
        ...
        setError(null);
        try {
            const data = paymentMode === "sponsored"
