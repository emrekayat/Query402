...
export default function App() {
    ...
    async function runPaidQuery() {
        ...
        try {
            ...
            let data;
            if (demoMode) {
                data = await fetchJson(`${API_BASE_URL}/api/demo/run`, {
                    method: "POST",
                ...
                data = await fetchJson(`${API_BASE_URL}/x402/${mode}?${params.toString()}`);
            }
            setResult(data);
            await refreshMetrics();
        }
